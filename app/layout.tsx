...
export const metadata = {
  title: 'Arief | Personal Portofolio',
  description: 'Arief Darma is fullsatack web develover and mobile depelover',
};
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      >
        <div className="bg-[#fbe2e3] absolute top-[-6rem] -z-10 rifht-[11rem] h-[31.25rem] w-[31.25rem] rounded-full blur-[10rem] sm:w-[68.75rem]"></div>
